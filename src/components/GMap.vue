<template>
  <div class="g-map-wrapper">
    ...
    <div class="g-video-panel">
      <div :class="state.videoPanelOpen ? 'g-video-item selection':'g-video-item' " @click="toogleVideoPanel()">
        <a>
          <VideoCameraOutlined class="fz20"/>
        </a>
      </div>
    </div>
    <!-- video panel -->
    <div v-if="state.videoPanelOpen" class="video-panel">
